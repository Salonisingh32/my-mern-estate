  ...
  return (
    <main className='p-3 max-w-4xl mx-auto'>
     ...
     <form className='flex flex-col sm:flex-row gap-4'>
      <div div className='flex flex-col gap-4 flex-1'>
        <input
         type="text" 
         placeholder='Name'
          className='border 
      ...
      <div className = "flex flex-col flex-1 gap-4">
        ...
        <span className='font-normal text-gray-700 ml-2'>The first image will be the cover (max 6)</span>
         ...
         <div className="flex gap-4">
          ...
          <button type='button' disabled={uploading} onClick={handleImageSubmit} className='p-3 text-green-700 border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-80'>
